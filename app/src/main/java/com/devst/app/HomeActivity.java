...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDetalle.setOnClickListener(v -> {
            ...
            intent.putExtra("titulo", DetalleManager.ultimoTitulo);
            intent.putExtra("descripcion", DetalleManager.ultimaDescripcion);
            startActivity(intent);
        });
        ...
        btnMaps.setOnClickListener(v -> {
            String coordenadas = "geo:-33.0472,-71.6127?q=Viña del Mar";
            Uri ubicacion = Uri.parse(coordenadas);
            Intent mapIntent = new Intent(Intent.ACTION_VIEW, ubicacion);
            startActivity(mapIntent);

            // 🔸 Guardamos los datos del último evento
            DetalleManager.ultimoTitulo = "Mapa abierto";
            DetalleManager.ultimaDescripcion = "Ubicación: Viña del Mar\nCoordenadas: -33.0472, -71.6127";
        });
        ...
        btnMensaje.setOnClickListener(view -> {
            String numero = "992034064";
            String texto = "Hola, no olvides tu proyecto";
            ...
            DetalleManager.ultimoTitulo = "Mensaje enviado";
            DetalleManager.ultimaDescripcion = "Número: " + numero + "\nTexto: " + texto;
        });
